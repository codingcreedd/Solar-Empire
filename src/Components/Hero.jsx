...
const Hero = () => {
  return (
    <div className="flex flex-col">
      ...
      <Product src="https://i.ibb.co/VST6MdH/Blue-Black-Minimalist-Modern-New-Collection-Backpack-Promotion-Instagram-Post-3.png" name="White/Black Solar Fan"
      unitPrice={42} lastPrice={75} title="Top Product" description="" wholesalePrice="Starting from $33.33" tag={<div className="px-2 py-1 bg-green-600 text-white rounded-full text-sm max-md:text-[0.8rem] max-md:py-0">Free Delivery</div>} outOfStock={false}/>
      ...
      <div className="flex flex-wrap justify-center items-center gap-4">
        {
          products.map(product => (
            <ProductCard key={uuid()} src={product.src} name={product?.name} tag={<div className="px-2 py-1 bg-green-600 text-white rounded-full text-sm max-md:text-[0.8rem] max-md:py-0">Free Delivery</div>}
