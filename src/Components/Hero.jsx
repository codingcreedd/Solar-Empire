  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="text-center flex flex-col mt-10 items-center gap-6">
        <h1 className="text-4xl font-bold text-green-600">Welcome to Solar Empire <sup className="text-md">TM</sup></h1>
        <p className="max-w-[50%]">Our mission is to empower your home with reliable and sustainable energy solutions, alleviating 
      ...
      <h1 className="border bg-green-600 text-white border-green-600 py-4 mx-10 rounded-xl text-4xl text-center mt-20 font-bold mb-20 hover:bg-green-600 hover:text-black transition-all hover:-translate-y-4">All Products</h1>
